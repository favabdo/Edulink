...
function SectionHeader({ title, icon, viewAllTo }: { title: string; icon: React.ReactNode; viewAllTo?: string }) {
...
function DailySchedule() {
  ...
  return (
    <section className={styles.card}>
      <SectionHeader title={t('dashboard.dailySchedule')} icon={<CalendarDays size={20} aria-hidden="true" />} viewAllTo="/schedule" />
        ...
        {todaySessions.map((session) => {
          ...
          return (
            <li key={session.id} className={styles.sessionRow}>
              {/* الترتيب في DOM = ترتيب القراءة: الوقت ثم المادة ثم الطالب ثم الحالة ثم الإجراء */}
...
function TodaySummary() {
  ...
  return (
    <section className={styles.card}>
      <SectionHeader title={t('dashboard.todaySummary')} icon={<CalendarDays size={20} aria-hidden="true" />} />
...
function RecentActivity() {
  ...
  return (
    <section className={styles.card}>
      <SectionHeader title={t('dashboard.recentActivity')} icon={<BarChart3 size={20} aria-hidden="true" />} />
